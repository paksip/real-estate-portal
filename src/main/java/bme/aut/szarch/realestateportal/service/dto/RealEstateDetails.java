...
public class RealEstateDetails   {
  ...
  */
  ...
  public RealEstateDetails userId(Long userId) {
    this.userId = userId;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, realEstateDetails.name) &&
        ...
        Objects.equals(this.userId, realEstateDetails.userId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, location, category, spectatorsCount, squareMeter, price, numberOfRooms, hasBalncony, hasAirCondition, ownerPhoneNumber, filePaths, reservations, userId);
  }
