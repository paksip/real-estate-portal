...
public class RealEstateDetailsDTO {
    ...
    public RealEstateDetailsDTO location(Location location) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, realEstateDetailsDTO.name) &&
            ...
            Objects.equals(this.location, realEstateDetailsDTO.location) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, description, location, category, spectatorsCount, squareMeter, price, numberOfRooms, hasBalncony, hasAirCondition, ownerPhoneNumber, filePaths, reservationDTOS, userId);
    }
