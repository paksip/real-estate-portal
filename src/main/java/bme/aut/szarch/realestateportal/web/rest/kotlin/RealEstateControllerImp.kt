...
open class RealEstateControllerImp(
    ...
    override fun updateRealEstate(
        realEstateId: Long,
        newRealEstate: NewRealEstateDTO
    ): ResponseEntity<Void> {
    ...
    override fun getRealEstatesByUserId(
        page: Int?,
        offset: Int?
    ): ResponseEntity<Page<RealEstateDTO>> {
    ...
    override fun creatNewAvailableReservationTime(
        realEstateId: Long,
    ...
    override fun getReservationDetails(
        realEstateId: Long,
        reservationId: Long
    ): ResponseEntity<ReservationDetailsDTO> {
        return reservationService.getReservationDetails(realEstateId, reservationId)
    }

    override fun makeNewReservation(
        realEstateId: Long,
        reservationId: Long,
