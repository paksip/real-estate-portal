...
interface RealEstateController {
    ...
    @PreAuthorize("hasRole(\"" + AuthoritiesConstants.USER + "\")")
    fun creatAvailReservetionTime(@ApiParam(value = "", required = true) @PathVariable("realEstateId") realEstateId: Long, @ApiParam(value = "") @Valid @RequestBody availableReservationTimeDTO: AvailableReservationTimeDTO): ResponseEntity<Any>
    ...
    fun makeNewReservation(@ApiParam(value = "", required = true) @PathVariable("realEstateId") realEstateId: Long, @ApiParam(value = "", required = true) @PathVariable("reservationId") reservationId: Long, @ApiParam(value = "") @Valid @RequestBody newReservationDTO: NewReservationDTO): ResponseEntity<Any>
